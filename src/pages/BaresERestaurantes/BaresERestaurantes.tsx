      ...
      <BgPage className="flex-grow-1">
        <Container>
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
            <TitlePage title="Bares e Restaurantes" />
            <SearchContainer className="d-flex align-items-center">
              <input
                ...
                aria-label="Buscar bares e restaurantes"
            ...
            {!isLoading &&
              ...
              restaurants.map((item) => (
                <Col key={item.id} className="d-flex">
                  <ItemCard endPoint="bares-e-restaurantes" item={item} />
                </Col>
              ))}
          </Row>
        </Container>
